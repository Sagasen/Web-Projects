        ...
        <div className="modal-overlay open">
          <div className="modal" style={{ maxWidth: '720px' }}>
            ...
            <div className="modal-body">
              <div className="grid-2">
                <div className="form-group">
                  ...
                  <input
                    className="form-control"
                    placeholder="Contoh: Deterjen Bubuk 800gr"
                    value={formName}
              ...
              <div className="form-group">
                ...
                <div className="image-upload-box" onClick={() => document.getElementById('product-image-input').click()} style={{ position: 'relative' }}>
                  <input
                  ...
                  {formImage ? (
                    <>
                      <img src={formImage} alt="Preview produk" />
                      <button
                        type="button"
                    ...
                    <div className="upload-hint">📤 Klik untuk upload gambar (opsional, kosongkan jika pakai ikon)</div>
                  )}
                  <div className="upload-hint">{formImageUploading ? 'Mengupload...' : (formImage ? 'Klik untuk ganti gambar' : '')}</div>
                </div>
              </div>
            ...
            <div className="modal-footer">
              ...
              <button className="btn btn-primary" onClick={handleSaveProduct} disabled={formImageUploading}>
                {formImageUploading ? '⏳ Menunggu upload gambar...' : '💾 Simpan Produk'}
              </button>
            </div>
          </div>
        </div>
