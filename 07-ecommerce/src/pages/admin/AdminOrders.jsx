...
const paymentLabel = (method) => {
  ...
  if (method === 'qris') return 'QRIS/E-Wallet'
          ...
          <div className="modal" style={{ maxWidth: '600px' }}>
            ...
            <div className="modal-body">
              ...
              <div style={{ marginBottom: 'var(--space-4)', fontSize: 'var(--text-sm)', color: 'var(--gray-700)' }}>
                ...
                <p>💳 <strong>Metode Pembayaran:</strong> {paymentLabel(selectedOrder.payment_method)}</p>
              ...
              {/* Payment Proof Image Preview (QRIS / Transfer Bank) */}
              {(selectedOrder.payment_method === 'qris' || selectedOrder.payment_method === 'transfer_bank') && selectedOrder.payment_proof_url && (
                <div style={{ marginTop: 'var(--space-4)', textAlign: 'center' }}>
                  <p style={{ fontWeight: 700, marginBottom: '8px', fontSize: 'var(--text-sm)' }}>
                    Bukti Pembayaran ({paymentLabel(selectedOrder.payment_method)}):
                  </p>
                  <img
