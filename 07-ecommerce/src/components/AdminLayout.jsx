    ...
    <div className="admin-layout">
      ...
      <nav className={`admin-sidebar ${sidebarOpen ? 'open' : ''}`} id="admin-sidebar">
        <div className="sidebar-logo">
          ...
          <div>
            <div className="sidebar-logo-text">Bakoel Umpluk</div>
        ...
        <div className="sidebar-nav">
          ...
          {isOwner && (
            <NavLink to="/admin/keuangan" className={({ isActive }) => `sidebar-link ${isActive ? 'active' : ''}`}>
              <span className="sidebar-link-icon">💰</span> Keuangan
            </NavLink>
          )}

          {isOwner && (
            <NavLink to="/admin/settings" className={({ isActive }) => `sidebar-link ${isActive ? 'active' : ''}`}>
              <span className="sidebar-link-icon">⚙️</span> Pengaturan
            </NavLink>
          )}
